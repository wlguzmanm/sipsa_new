...
/**
 * DAO for table "FUENTE_ARTICULO".
 */
public class FuenteArticuloDao extends AbstractDao<FuenteArticulo, Long> {

    public static final String TABLENAME = "FUENTE_ARTICULO";
    ...
    private Query<FuenteArticulo> tipoRecoleccion_FuenArtiTipoRecoleccionQuery;
    private Query<FuenteArticulo> fuente_FuenteQuery;

    public FuenteArticuloDao(DaoConfig config) {
        super(config);
    }

    public FuenteArticuloDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FUENTE_ARTICULO\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"FUENTE_ARTICULO\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, FuenteArticulo entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public FuenteArticulo readEntity(Cursor cursor, int offset) {
        FuenteArticulo entity = new FuenteArticulo( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, FuenteArticulo entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(FuenteArticulo entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(FuenteArticulo entity) {
        if(entity != null) {
    ...
    public List<FuenteArticulo> _queryTipoRecoleccion_FuenArtiTipoRecoleccion(Long tireId) {
        synchronized (this) {
            if (tipoRecoleccion_FuenArtiTipoRecoleccionQuery == null) {
                QueryBuilder<FuenteArticulo> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.TireId.eq(null));
                tipoRecoleccion_FuenArtiTipoRecoleccionQuery = queryBuilder.build();
            }
        }
        Query<FuenteArticulo> query = tipoRecoleccion_FuenArtiTipoRecoleccionQuery.forCurrentThread();
        query.setParameter(0, tireId);
        return query.list();
    }

    /** Internal query to resolve the "fuente" to-many relationship of Principal. */
    public List<FuenteArticulo> _queryFuente_Fuente(Long fuenId) {
        synchronized (this) {
        ...
        Query<FuenteArticulo> query = fuente_FuenteQuery.forCurrentThread();
