...
/**
 * DAO for table "OBSERVACION_DISTRITO".
*/
public class ObservacionDistritoDao extends AbstractDao<ObservacionDistrito, Long> {

    public static final String TABLENAME = "OBSERVACION_DISTRITO";
    ...
    */
    ...
    public ObservacionDistritoDao(DaoConfig config) {
        super(config);
    }

    public ObservacionDistritoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"OBSERVACION_DISTRITO\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"OBSERVACION_DISTRITO\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, ObservacionDistrito entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public ObservacionDistrito readEntity(Cursor cursor, int offset) {
        ObservacionDistrito entity = new ObservacionDistrito( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, ObservacionDistrito entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(ObservacionDistrito entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(ObservacionDistrito entity) {
        if(entity != null) {
