...
public class ListFuenteAdapter extends RecyclerView.Adapter<ListFuenteAdapter.ViewHolder> {
    ...
    public ListFuenteAdapter(Activity context, List<Fuente> fuentes) {
    ...
    @Override
    public ListFuenteAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,int viewType) {


        //create view and viewholder
        View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_fuente, null);
