...
/**
 * Created by andreslopera on 12/06/19.
 */
public class ResumenFuentesDistritoActivity extends App {
                        ...
                        if (Util.isNetworkAvailable(getApplicationContext())) {
                            task_transmitirHttp = new AsyncTask<Void, Void, Status>() {
                                ...
                                protected void onPreExecute() {
                                    pdialog = ProgressDialog.show(ResumenFuentesDistritoActivity.this, "",
