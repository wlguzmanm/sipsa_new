...
import gov.dane.sipsa.adapter.AddElementoRecyclerAdapterDistrito;
...
/**
 * Created by mguzman on 30/04/18
 */
public class FuenteAddElementoDistritoActivity extends App {
    public FuenteArticuloDistrito factor;
    ...
    public AddElementoRecyclerAdapterDistrito productAdapter;

    public List<Elemento> elementos = new ArrayList<>();
    public List<FuenteArticuloDistrito> listFactor = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fuente_add_producto_distrito);
        spFactorArticulo = (Spinner) findViewById(R.id.spFactorArticuloDistrito);
        ...
        toolbar.setSubtitle(fuente.getMuniNombre());
        ...
        taskCargarElementos = new AsyncTask<Void, Void, Status>() {
            ...
            protected void onPreExecute() {
                pdialog = ProgressDialog.show(FuenteAddElementoDistritoActivity.this, "",
            ...
            protected gov.dane.sipsa.model.Status doInBackground(Void... params) {
                ...
                elementos = databaseManager.listaElementoDistritoByTireId(13L, fuente.getFuenId(), fuente.getMuniId());
                return status;
            }
            ...
            protected void onPostExecute(gov.dane.sipsa.model.Status result) {
                if (elementos != null) {
                   ...
                   productAdapter =  new AddElementoRecyclerAdapterDistrito(elementos,fuente,factor);
                    RecyclerView recyclerView = (RecyclerView) findViewById(R.id.listaProdutosDistrito);
        ...
        factorArrayAdapter = new ArrayAdapter<FuenteArticuloDistrito>(this, R.layout.spinner_item, listFactor);
       ...
       /* Grupo g = new Grupo();
        ...
        grupoList.add(g);
        grupoList.addAll( databaseManager.listaGrupoByTireId(13L));*/
        ...
        FloatingActionButton fabVincularProducto = (FloatingActionButton) findViewById(R.id.fabVincularProductoDistrito);
    ...
    protected void onPostExecute(Status result) {
        elementos = databaseManager.listaElementoByTireId(13L, fuente.getFuenId(), fuente.getMuniId());
    }
    ...
    public void procesoAgregarElementos() {
        ...
        task=new AsyncTask<Void, Void, Status>() {
            ...
            {
                pdialog = ProgressDialog.show(FuenteAddElementoDistritoActivity.this, "",
                        "Agregando elementos a la factor, espere un momento..--DISTRITO");
                super.onPreExecute();
            }
            ...
            protected gov.dane.sipsa.model.Status doInBackground (Void...params)
            {
                ...
                if (isChecked) {
                    ...
                    status.setDescription("Articulos Agregados Exitosamente a la factor.--DISTRITO");
                } else {
                    status.setType(gov.dane.sipsa.model.Status.StatusType.ERROR);
                    status.setDescription("Debe seleccionar al menos un elemento para agregar a la factor.--DISTRITO");
                }
                return  status;
            }
