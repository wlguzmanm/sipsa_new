...
public class FuenteResumenRecyclerAdapter extends RecyclerView.Adapter<FuenteResumenRecyclerAdapter.ViewHolder> {
    ...
    public FuenteResumenRecyclerAdapter(List<Fuente> items) {
        mItems = items;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.fragment_fuente_resumen, viewGroup, false);
