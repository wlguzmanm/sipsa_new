...
*/
public class RecoleccionDistritoDao extends AbstractDao<RecoleccionDistrito, Long> {

    public static final String TABLENAME = "RECOLECCION_DISTRITO";
    ...
    */
    public static class Properties {
        ...
        public final static Property ObservacionArticulo = new Property(40, String.class, "observacionArticulo", false, "OBSERVACION_ARTICULO");
        public final static Property Frecuencia = new Property(41, String.class, "frecuencia", false, "FRECUENCIA");
        public final static Property UnidadMedidaOtroNombre = new Property(42, String.class, "unidadMedidaOtroNombre", false, "UNME_NOMBRE_OTRO");

    };

    private Query<RecoleccionDistrito> unidadMedida_UnmePrincipalQuery;
    private Query<RecoleccionDistrito> tipoRecoleccion_TirePrincipalQuery;
    private Query<RecoleccionDistrito> fuente_FuenPrincipalQuery;
    private Query<RecoleccionDistrito> articulo_ArtiPrincipalQuery;
    private Query<RecoleccionDistrito> casaComercial_CacoPrincipalQuery;

    public RecoleccionDistritoDao(DaoConfig config) {
        super(config);
    }

    public RecoleccionDistritoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"RECOLECCION_DISTRITO\" (" + //
                ...
                "\"OBSERVACION_ARTICULO\" TEXT," + //40:Observacion Articulo
                "\"FRECUENCIA\" TEXT," +  //41:Frecuencia
                "\"UNME_NOMBRE_OTRO\" TEXT );");  //42:unme otro
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"RECOLECCION_DISTRITO\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, RecoleccionDistrito entity) {
        stmt.clearBindings();
        ...
        String observacionP = entity.getObservacionProducto();
        if (observacionP != null) {
            stmt.bindString(41, observacionP);
        }

        String frecuencia = entity.getFrecuencia();
        if (frecuencia != null) {
            stmt.bindString(42, frecuencia);
        }

        String unidadOtro = entity.getUnidadMedidaOtroNombre();
        if (unidadOtro != null) {
            stmt.bindString(43, unidadOtro);
        }
    ...
    /** @inheritdoc */
    @Override
    public RecoleccionDistrito readEntity(Cursor cursor, int offset) {
        RecoleccionDistrito entity = new RecoleccionDistrito( //
            ...
            cursor.isNull(offset + 40) ? null : cursor.getString(offset + 40), // cacoId
            cursor.isNull(offset + 41) ? null : cursor.getString(offset + 41), // frecuencia
            cursor.isNull(offset + 42) ? null : cursor.getString(offset + 42)
        );
        return entity;
    }
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, RecoleccionDistrito entity, int offset) {
        ...
        entity.setObservacionProducto(cursor.isNull(offset + 40) ? null : cursor.getString(offset + 40));
        entity.setFrecuencia(cursor.isNull(offset + 41) ? null : cursor.getString(offset + 41));
        entity.setUnidadMedidaOtroNombre(cursor.isNull(offset + 42) ? null : cursor.getString(offset + 42));
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(RecoleccionDistrito entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(RecoleccionDistrito entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    public List<RecoleccionDistrito> _queryUnidadMedida_UnmePrincipal(Long unmeId) {
        synchronized (this) {
            if (unidadMedida_UnmePrincipalQuery == null) {
                QueryBuilder<RecoleccionDistrito> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.UnmeId.eq(null));
                unidadMedida_UnmePrincipalQuery = queryBuilder.build();
            }
        }
        Query<RecoleccionDistrito> query = unidadMedida_UnmePrincipalQuery.forCurrentThread();
        query.setParameter(0, unmeId);
        return query.list();
    }

    /** Internal query to resolve the "tirePrincipal" to-many relationship of TipoRecoleccion. */
    public List<RecoleccionDistrito> _queryTipoRecoleccion_TirePrincipal(Long tireId) {
        synchronized (this) {
        ...
        Query<RecoleccionDistrito> query = tipoRecoleccion_TirePrincipalQuery.forCurrentThread();
        query.setParameter(0, tireId);
        return query.list();
    }

    /** Internal query to resolve the "fuenPrincipal" to-many relationship of Fuente. */
    public List<RecoleccionDistrito> _queryFuente_FuenPrincipal(Long fuenId) {
        synchronized (this) {
        ...
        Query<RecoleccionDistrito> query = fuente_FuenPrincipalQuery.forCurrentThread();
        query.setParameter(0, fuenId);
        return query.list();
    }

    /** Internal query to resolve the "artiPrincipal" to-many relationship of Articulo. */
    public List<RecoleccionDistrito> _queryArticulo_ArtiPrincipal(Long artiId) {
        synchronized (this) {
        ...
        Query<RecoleccionDistrito> query = articulo_ArtiPrincipalQuery.forCurrentThread();
        query.setParameter(0, artiId);
        return query.list();
    }

    /** Internal query to resolve the "cacoPrincipal" to-many relationship of CasaComercial. */
    public List<RecoleccionDistrito> _queryCasaComercial_CacoPrincipal(Long cacoId) {
        synchronized (this) {
        ...
        Query<RecoleccionDistrito> query = casaComercial_CacoPrincipalQuery.forCurrentThread();
