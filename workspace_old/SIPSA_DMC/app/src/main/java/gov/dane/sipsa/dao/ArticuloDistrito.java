...
/**
 * Entity mapped to table "ARTICULO_DISTRITO".
 */
public class ArticuloDistrito  implements Serializable {
    ...
    private transient ArticuloDistritoDao myDao;

    private List<Recoleccion> artiPrincipal;

    public ArticuloDistrito() {
    }

    public ArticuloDistrito(Long articacoId) {
        this.articacoId = articacoId;
    }

    public ArticuloDistrito(Long articacoId, Long artiId, String artiNombre, String cacoNombre, String tireNombre, String grupNombre, String articacoRegicaLinea, Long tireId, Long cacoId) {
        this.articacoId = articacoId;
        this.artiId = artiId;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getArticuloDistrtioDao() : null;
    }
