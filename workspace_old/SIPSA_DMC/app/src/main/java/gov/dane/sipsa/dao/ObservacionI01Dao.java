...
/** 
 * DAO for table "OBSERVACION_I01".
*/
public class ObservacionI01Dao extends AbstractDao<ObservacionI01, Long> {

    public static final String TABLENAME = "OBSERVACION_I01";

    /**
     * Properties of entity ObservacionI01.<br/>
    ...
    */
    ...
    public ObservacionI01Dao(DaoConfig config) {
        super(config);
    }
    
    public ObservacionI01Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"OBSERVACION_I01\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"OBSERVACION_I01\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, ObservacionI01 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public ObservacionI01 readEntity(Cursor cursor, int offset) {
        ObservacionI01 entity = new ObservacionI01( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, ObservacionI01 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(ObservacionI01 entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(ObservacionI01 entity) {
        if(entity != null) {
