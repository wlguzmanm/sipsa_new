...
/**
 * DAO for table "FUENTE_DISTRITO".
*/
public class FuenteDistritoDao extends AbstractDao<FuenteDistrito, Long> {

    public static final String TABLENAME = "FUENTE_DISTRITO";
    ...
    */
    ...
    public FuenteDistritoDao(DaoConfig config) {
        super(config);
    }

    public FuenteDistritoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        if(ifNotExists){
            Cursor cursor = db.rawQuery("pragma table_info(FUENTE_DISTRITO)", null);
            if (cursor != null) {
                if (cursor.getCount() > 0) {
                    ...
                    if(!campo1)db.execSQL("ALTER TABLE FUENTE_DISTRITO ADD COLUMN FUEN_TELEFONO_INFORMANTE TEXT");
                    if(!campo2)db.execSQL("ALTER TABLE FUENTE_DISTRITO ADD COLUMN FUEN_CODIGO_INTERNO TEXT");
                    if(!campo3)db.execSQL("ALTER TABLE FUENTE_DISTRITO ADD COLUMN TIRE_ID INTEGER");
                }
                cursor.close();
            }
        }

        db.execSQL("CREATE TABLE " + constraint + "\"FUENTE_DISTRITO\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"FUENTE_DISTRITO\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, FuenteDistrito entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(FuenteDistrito entity) {
    ...
    /** @inheritdoc */
    @Override
    public FuenteDistrito readEntity(Cursor cursor, int offset) {
        FuenteDistrito entity = new FuenteDistrito( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, FuenteDistrito entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(FuenteDistrito entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(FuenteDistrito entity) {
        if(entity != null) {
