...
public class SettingsActivityDistrito extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_settings_distrito);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        toolbar.setTitle("Configuraciones distrito");
        ...
        swTransmisionLocal = (Switch) findViewById(R.id.swTransmisionLocalDistrito);
